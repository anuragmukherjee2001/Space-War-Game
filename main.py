...
mixer.music.load('Sound Effects/background.mp3')
mixer.music.play(-1)
...
font = pygame.font.Font('Fonts/Cartoon Cookies Tilted.ttf',32)
...
game_over_font = pygame.font.Font('Fonts/CHICKEN Pie.ttf',60)

# Your Score Text

Your_score_Font = pygame.font.Font('Fonts/CHICKEN Pie.ttf',30)
